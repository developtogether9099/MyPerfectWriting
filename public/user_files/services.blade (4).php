            ...
            <div class="row" style="display: none;" id="step2">
              ...
              <div class="col-md-12 mt-2">
                <div class="form-group">
                  ...
                  <input type="text" name="sources" id="f-sources" class="form-control" placeholder="Number of Sources">
                </div>
              </div>
              <div class="col-md-12 mt-2">
                <div class="form-group">
              ...
              <div class="col-md-12 mt-2 row" style="padding-top: 50px;">
                ...
                <div class="col-md-6">
                  <div class="card border-0 form-group py-2 plan{{$i++}}" style=" color: #000000; height:170px">
              ...
              <div class=" text-white">
                ...
                <p>
                  My File
				   ...
				   <a id="file_path" href="#" class="float-right text-white"><i class="fa fa-download"></i> </a>
      ...
      <div class="card-body pt-2">
        ...
        <div class="box-content" style="color: #ffffff;">
          <div class="col-md-12 col-sm-12 pr-4">
            ...
            <div>
              <p class="fs-12 p-family">{{ __('Total Payment') }} <span class="checkout-cost"> <i class="fa {{format_amount(1)['icon']}}"></i> <span class="text-info" id="gtotal">0</span></span></p>
            </div>




           <button type="button" class="btn btn-primary" style="width: 100%;" data-bs-toggle="modal" data-bs-target="#exampleModal2">Checkout</button>
...
<div class="modal fade" id="exampleModal2" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true" >
  ...
  <div class="modal-dialog modal-lg">
    <div class=" modal-content">
      <div>
        <h3 style="text-align: center;"><strong>Convenient Payment Options: Select Your Preferred Method</strong></h3>
        <h5 style="text-align: center;">Please review your order details below and proceed to secure payment to complete your purchase.</h5>
      </div>
...
<div class="card border-0" style="background-color: #3C3465; color: #ffffff;">
  ...
  <img src="paypal_logo.png" alt="PayPal Logo" style="float: right;">
</div>
  ...
  <img src="stripe_logo.png" alt="Stripe Logo" style="float: right;">
</div>
          ...
          <div class="col-md-6">
            ...
            <div class="card border-0" style="background-color: #3C3465; color: #ffffff;">
              <div class="card-body">
                ...
                <div class="card-text">
                  <p class="fs-12 p-family">Subtotal: <span class="checkout-cost"><i class="fa {{format_amount(1)['icon']}}"></i><span id="sub_total">0</span></span></p>
                  <p class="fs-12 p-family" style="color: #ffffff;">Total Payment: <span class="checkout-cost"><i class="fa {{format_amount(1)['icon']}}"></i><span class="text-info" id="gtotal">0</span></span></p>
                </div>
				  <br>
               <button type="submit" class="btn btn-primary btn-lg btn-block confirm-button pl-6 pr-6 mb-1" style="width: 100%" disabled>Checkout Now</button>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $('#placeOrder').click(function() {
		  ...
		  if(title !== '' && subject !== '' && citation !== '' && sources !== '' && desc !== '') { 
        bool = true;
