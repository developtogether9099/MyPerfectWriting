...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <img src="{{ URL::asset('img/brand/logo.png') }}" alt="My Perfect Writing" style="width: 200px;">
</a>
												...
												<div class="collapse navbar-collapse section-links" id="navbarNav">
													<ul class="navbar-nav">
														<li class="nav-item">
															<a class="nav-link scroll" id="home" href="{{route('home')}}">{{ __('Home') }} <span class="sr-only">(current)</span></a>
														</li>		
														@if (config('frontend.pricing_section') == 'on')
															<li class="nav-item">
																<a class="nav-link scroll" href="{{route('pricing')}}">{{ __('Pricing') }}</a>
															</li>
														@endif							
													
															@if (config('frontend.blogs_section') == 'on')
															<li class="nav-item">
																<a class="nav-link scroll" id="blogss" href="{{route('blogs')}}">{{ __('Blogs') }}</a>
															</li>
														@endif
														
														@if (config('frontend.services_section') == 'on')
															<li class="nav-item">
																<a class="nav-link scroll" id="services" href="{{route('services')}}">{{ __('Services') }}</a>
															</li>
														@endif
														@if (config('frontend.faq_section') == 'on')
															<li class="nav-item">
																<a class="nav-link scroll" href="{{route('home')}}/#faq-wrapper">{{ __('FAQs') }}</a>
															</li>
														@endif
														@if (config('frontend.contact_section') == 'on')
															<li class="nav-item">
																<a class="nav-link scroll" href="{{route('home')}}/#contact-wrapper">{{ __('Contact Us') }}</a>
															</li>
														@endif
