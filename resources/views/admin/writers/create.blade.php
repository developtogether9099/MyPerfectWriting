	...
	<div class="col-xl-9 col-lg-8 col-sm-12">
		<div class="card border-0">
			...
			<div class="card-body pb-0">
				<form method="POST" action="{{ route('admin.writer_store') }}" enctype="multipart/form-data">
					@csrf
					...
					<div class="row">
						...
						<div class="col-sm-6 col-md-6">
							<div class="input-box">
								<div class="form-group">
									...
									<input type="text" class="form-control @error('username') is-danger @enderror" name="username" id="username" value="{{$username}}" required>
						...
						<div class="col-sm-6 col-md-6">
							<div class="input-box">
								<div class="form-group">
									<label class="form-label fs-12">{{ __('Password') }} <span class="text-muted">({{ __('Required') }})</span></label>
									<input type="text" class="form-control @error('password') is-danger @enderror" name="password" required>
									@error('password')
						...
						<div class="col-md-6 col-sm-12">
							<div class="form-group">
								...
								<input type="file" class="form-control @error('file') is-danger @enderror" name="file" required>
									@error('file')
