...
@section('page-header')
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0">{{ __('New Service Post') }}</h4>
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item" aria-current="page"><a href="{{ route('admin.settings.service') }}"> {{ __('Services Manager') }}</a></li>
				<li class="breadcrumb-item active" aria-current="page"><a href="{{url('#')}}"> {{ __('New Service Post') }}</a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
		...
		<div class="col-lg-8 col-md-8 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-header">
					<h3 class="card-title">{{ __('Create New Service Post') }}</h3>
				</div>
				<div class="card-body pt-5">									
					<form id="" action="{{ route('admin.settings.service.store') }}" method="post" enctype="multipart/form-data">
						@csrf

						<div class="row mt-2">							
							<div class="col-lg-12 col-md-12 col-sm-12">							
								<div class="input-box">								
									<h6>{{ __('Service Title') }}  <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
							...
							<div class="col-lg-6 col-md-6 col-sm-12">							
								<div class="input-box">	
									<h6>{{ __('Service Status') }}  <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
			  						<select id="smtp-encryption" name="status" data-placeholder="{{ __('Service Status') }}:">			
						...
						<div class="row mt-2">
							<div class="col-lg-12 col-md-12 col-sm-12">	
								<div class="input-box">	
									<h6>{{ __('Service Post Content') }} <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>							
						...
						<div class="border-0 text-right mb-2 mt-1">
							<a href="{{ route('admin.settings.service') }}" class="btn btn-cancel mr-2">{{ __('Cancel') }}</a>
