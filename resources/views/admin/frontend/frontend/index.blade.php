					...
					<form action="{{ route('admin.settings.frontend.store') }}" method="POST" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-12">									
								...
								<div class="col-md-4 col-sm-12">									
								<h6 class="fs-12 font-weight-bold mb-4">{{ __('Services Section') }}</h6>								
								<div class="form-group mb-4">
									<label class="custom-switch">
										<input type="checkbox" name="services" class="custom-switch-input" @if ( config('frontend.services_section')  == 'on') checked @endif>
										<span class="custom-switch-indicator"></span>
										<span class="custom-switch-description">{{ __('Show') }}</span>
									</label>
								</div> 
