	...
	<script type="text/javascript">
		$(function () {
			...
			var table = $('#listUsersTable').DataTable({
				...
				processing: true,
				serverSide: true,
				ajax: "{{ route('admin.pending_for_approval') }}",
				columns: [
					{
						data: 'title',
						name: 'title',
