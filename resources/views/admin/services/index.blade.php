...
<div class="page-header mt-5-7">
    <div class="page-leftheader">
        <h4 class="page-title mb-0">{{ __('All Services') }}</h4>
        <ol class="breadcrumb mb-2">
            <li class="breadcrumb-item"><a href="{{ route('admin.dashboard') }}"><i class="fa-solid fa-id-badge mr-2 fs-12"></i>{{ __('Admin') }}</a></li>
            <li class="breadcrumb-item" aria-current="page">{{ __('Services List') }}</li>
        </ol>
    </div>
    <div class="page-rightheader">
		<a href="{{ route('admin.service_create') }}" class="btn btn-primary mt-1">{{ __('Create New Service') }}</a>
	</div>
                    ...
                    <table id='listUsersTable' class='table listUsersTable' width='100%'>
                        <thead>
                            <tr>
                                ...
                                <th width="7%">{{ __('Price Type') }}</th>
                                <th width="5%">{{ __('Status') }}</th>
                                <th width="3%" class="text-center">{{ __('Actions') }}</th>
                            </tr>
                        </thead>
                        <tbody>
