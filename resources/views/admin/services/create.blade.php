...
<div class="page-header mt-5-7">
	<div class="page-leftheader">
		<h4 class="page-title mb-0">{{ __('Create Service') }}</h4>
	...
	<div class="col-xl-9 col-lg-8 col-sm-12">
		<div class="card border-0">
			...
			<div class="card-body pb-0">
				<form method="POST" action="{{ route('admin.service_store') }}" enctype="multipart/form-data">
					@csrf
					...
					<div class="row">
						...
						<div class="col-sm-6 col-md-3">
							<div class="input-box">
								<div class="form-group">
									...
									<input type="text" class="form-control @error('price') is-danger @enderror" name="price" required>
									@error('price')
						...
						<div class="col-sm-6 col-md-6">
							<div class="input-box">
								<div class="form-group">
									...
									<input type="text" class="form-control @error('single_spacing_price') is-danger @enderror" name="single_spacing_price" required>
						...
						<div class="col-sm-6 col-md-6">
							<div class="input-box">
								<div class="form-group">
									...
									<input type="text" class="form-control @error('double_spacing_price') is-danger @enderror" name="double_spacing_price" required>
						...
						<div class="col-md-6 col-sm-12">
							<div class="form-group">
								...
								<input type="number" class="form-control @error('minimum_order_quantity') is-danger @enderror" name="minimum_order_quantity" required>
