				...
				<div class="card-body">			
					<div class="text-center">
						...
						<div class="text-center mb-6">
							<p class="mt-5 fs-14">{{ __('You have successfully Completed Payment process') }}.</p>
						</div>						
					
						<div class="text-center pt-2 pb-4">
						
							<a href="{{ route('user.my_orders') }}" id="payment-button" class="btn btn-primary pl-6 pr-6">{{ __('View Orders') }}</a>							
						</div>
					</div>
				</div>
			</div>
