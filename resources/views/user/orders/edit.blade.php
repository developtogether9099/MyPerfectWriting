            ...
            <div class="row" id="step1">
              ...
              <div class="col-md-12 mt-2">
                <div class="form-group">
                  ...
                  <select name="service_id" class="form-control" id="f-service" required>
                    <option value="{{$sservice->id}}" selected>{{$sservice->name}}</option>
              ...
              <div class="col-md-12 mt-2">
                <div class="form-group">
                  ...
                  <select name="work_level_id" class="form-control" id="f-wl" required>
                    <option value="{{$swork_level->id}}" selected>{{$swork_level->name}}</option>
              ...
              <div class="col-md-6 mt-2">
                <div class="form-group">
                  ...
                  <div class="d-flex">
                    ...
                    <input type="number" name="qty" class="text-center no-arrows" id="quantity" value="{{$order->quantity}}" min="1" style="width:100%; border:none">
              ...
              <div class="col-md-4 mt-2">
                <div class="form-group">
                  ...
                  <input type="date" name="deadline_date" id="deadline-date" value="{{$order->dead_line}}" class="form-control" required>
                </div>
              </div>
              <div class="col-md-2 mt-2">
                <div class="form-group">
                  ...
                  <select name="deadline_time" id="deadline-time" class="form-control" required>
					       <option value="{{$order->deadline_time}}">{{$order->deadline_time}}</option>
                    @for ($hour = 0; $hour < 24; $hour++) @for ($minute=0; $minute < 60; $minute +=15)
					  
					  <option value="{{ sprintf('%02d:%02d', $hour, $minute) }}">{{ sprintf('%02d:%02d', $hour, $minute) }}
                      </option>
                      @endfor
                      @endfor
                  </select>
            ...
            <div class="row" style="display: none;" id="step2">
              ...
              <div class="col-md-12 mt-2">
                <div class="form-group">
                  ...
                  <input type="text" name="title" id="f-title"  value="{{$order->title}}" class="form-control" placeholder="Title of your document" required>
                </div>
              </div>
              <div class="col-md-12 mt-2">
                <div class="form-group">
                  ...
                  <select name="course" id="f-course" class="form-control" required>
                   <option value="{{$order->course}}">{{$order->course}}</option>
              ...
              <div class="col-md-12 mt-2">
                <div class="form-group">
                  ...
                  <select name="formatting2" id="f-formatting" class="form-control" required>
                    <option value="{{$order->formatting}}">{{$order->formatting}}</option>>
              ...
              <div class="col-md-12 mt-2">
                <div class="form-group">
                  ...
                  <input type="text" name="sources" id="f-sources"  value="{{$order->sources}}" class="form-control" placeholder="Number of Sources">
                </div>
              </div>
              <div class="col-md-12 mt-2">
                <div class="form-group">
...
<div id="checkouts" style="display:none">
            ...
            <div>
              <p class="fs-12 p-family">{{ __('Total Payment') }} <span class="checkout-cost"> <i class="fa {{format_amount(1)['icon']}}"></i> <span class="text-info" id="gtotal">{{$order->total}}</span></span></p>
            </div>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $('#update-order').submit(function(e) {
        ...
        var url = "{{ route('user.update_unpaid_order', $order->id) }}"; // Replace with the actual URL for submitting the order
        if (bool == true) {
