...
class BlogsController extends Controller
{
    ...
    {
        if ($request->ajax()) {
            $data = Blog::where('created_by', auth()->user()->name)->get()->sortByDesc("created_at");
            return Datatables::of($data)
                    ->addIndexColumn()
                    ->addColumn('actions', function($row){
                        $actionBtn = '<div>                                            
                                            <a href="'. route("blogger.blog.edit", $row["id"] ). '"><i class="fa-solid fa-pencil-square table-action-buttons edit-action-button" title="Edit Blog"></i></a>
        ...
        return view('blogger.blogs.index');
    }
    ...
    {
        return view('blogger.blogs.edit', compact('id'));
    }
