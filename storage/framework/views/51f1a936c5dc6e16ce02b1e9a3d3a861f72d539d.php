...
<div class="page-header mt-5-7">
    <div class="page-leftheader">
        <h4 class="page-title mb-0"><?php echo e(__('Review Order Details')); ?></h4>
        <ol class="breadcrumb mb-2">
            <li class="breadcrumb-item"><a href="<?php echo e(route('user.dashboard')); ?>"><?php echo e(__('Dashboard')); ?></a></li>
            <li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(route('user.unpaid_orders')); ?>"> <?php echo e(__('Unpaid Orders')); ?></a></li>
        </ol>
    </div>
</div>
<!-- END PAGE HEADER -->
...
<div class="row">
  <div class="col-lg-8 col-md-8 col-sm-8">
              ...
              <div class=" text-white " >
                ...
                <p>
                  Service Type
                  <span class="float-right" id="bservice"> <?php echo e($sservice->name); ?></span>
                </p>
                <p>
                  Education Level
                  <span class="float-right" id="bwork_level"> <?php echo e($swork_level->name); ?></span>
                </p>
                <p>
                  Writer Level
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/myperfectwriting.co.uk/httpdocs/resources/views/user/orders/pay_now.blade.php ENDPATH**/ ?>