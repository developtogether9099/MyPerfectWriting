            ...
            <p>
              My File
          	 ...
          	 <?php if($attachments->count() > 0): ?>
				<?php $__currentLoopData = $attachments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $atch): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
              <a target="_blank" href="<?php echo e($atch->file_path); ?>" class="float-right text-white"><i class="fa fa-download"></i> </a>
              <span class="float-right mr-2" id="file_name"><?php echo e($atch->file); ?></span> 
				<br>
...
<div id="process_url" data-processurl="<?php echo e(route('stripe_process_payment')); ?>"></div>
...
</html><?php /**PATH /var/www/vhosts/myperfectwriting.co.uk/portal.myperfectwriting.co.uk/resources/views/paymentOfOrder.blade.php ENDPATH**/ ?>