...
<div class="page-header mt-5-7">
	<div class="page-leftheader">
		<h4 class="page-title mb-0"><?php echo e(__('Edit Order')); ?></h4>
	...
	<div class="col-xl-12 col-lg-12 col-sm-12">
		<div class="card border-0">
			...
			<div class="card-body pb-0 p-3 rounded"  style="background-color: #3C3465; color: #ffffff;">
				<form method="POST" class="row" action="<?php echo e(route('admin.order_update', $order->id)); ?>" enctype="multipart/form-data">
            ...
            <?php echo csrf_field(); ?>
              ...
              <div class="col-md-6 mt-2">
                <div class="form-group">
                  ...
                  <select name="service_id" class="form-control" id="f-service" required>
                    <option value="<?php echo e($sservice->id); ?>"><?php echo e($sservice->name); ?></option>
              ...
              <div class="col-md-4 mt-2">
                <div class="form-group">
                  ...
                  <select name="work_level_id" class="form-control" id="f-wl" required>
                     <option value="<?php echo e($swork_level->id); ?>"><?php echo e($swork_level->name); ?></option>
              ...
              <div class="col-md-2 mt-2">
                <div class="form-group">
                  <label for="quantity">No. of pages</label>
                    ...
                    <input type="number" name="qty" class="form-control" id="quantity" value="<?php echo e($order->quantity); ?>" min="1" style="width:100%;">
              ...
              <div class="col-md-4 mt-2">
                <div class="form-group">
                  ...
                  <input type="date" name="deadline_date" id="deadline-date" value="<?php echo e($order->dead_line); ?>" class="form-control" value="<?php echo e(date('Y-m-d')); ?>" min="<?php echo e(date('Y-m-d')); ?>" required>
                </div>
              </div>
   ...
   <div class="col-md-6 mt-2">
                <div class="form-group">
                  ...
                  <select name="course" id="f-course" class="form-control" required>
                     <option value="<?php echo e($ssubject->name); ?>"><?php echo e($ssubject->name); ?></option>
              ...
              <div class="col-md-6 mt-2">
                <div class="form-group">
                  ...
                  <input type="text" name="title" id="f-title" class="form-control" value="<?php echo e($order->title); ?>" placeholder="Title of your document" required>
                </div>
              </div>
              ...
              <div class="col-md-6 mt-2">
                <div class="form-group">
                  ...
                  <select name="formatting2" id="f-formatting" class="form-control" required>
                     <option value="<?php echo e($scitation->name); ?>"><?php echo e($scitation->name); ?></option>
              ...
              <div class="col-md-6 mt-2">
                <div class="form-group">
                  ...
                  <input type="text" name="sources" id="f-sources" class="form-control"  value="<?php echo e($order->sources); ?>" placeholder="Number of Sources" required>
                </div>
              </div>
				   <div class="col-md-6 mt-2">
                <div class="form-group">
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/myperfectwriting.co.uk/portal.myperfectwriting.co.uk/resources/views/admin/orders/edit.blade.php ENDPATH**/ ?>