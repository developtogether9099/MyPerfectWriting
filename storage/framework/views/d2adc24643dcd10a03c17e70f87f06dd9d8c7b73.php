  ...
  color: #000000;
   ...
   <div style="text-align: center;">
                                ...
                                <?php if(config('settings.oauth_login') == 'enabled'): ?>
                                    <div class="divider">
                                        <div class="divider-text text-muted">
                                            <small><?php echo e(__('Sign Up with')); ?></small>
                                        </div>
                                    </div>
                                    ...
                                    <div class="divider">
                                        <div class="divider-text text-muted">
                                            <small><?php echo e(__('or Sign Up with email')); ?></small>
                                        </div>
                                    </div>
                                <?php endif; ?>
    ...
    <label class="fs-12 font-weight-bold d-flex align-items-center justify-content-between">
        <span><?php echo e(__('Username')); ?><a id="info-icon"><i class="fas fa-info-circle"></i></a></span>
        <p class="fs-10 text-muted mt-2">
  Already have an account? Just <a class="text-info" href="<?php echo e(route('login')); ?>"><?php echo e(__('Login')); ?></a>
</p>

    </label>
    <div class="d-flex align-items-center">
        <input type="text" class="form-control" name="username" id="username" value="<?php echo e($username); ?>" required autocomplete="off" readonly placeholder="<?php echo e(__('Username')); ?>">
...
<div class="input-box">
    ...
    <?php echo e(__('By continuing, I agree with your')); ?>

    <a href="<?php echo e(route('terms')); ?>" class="text-info"><?php echo e(__('Terms and Conditions')); ?></a>
    <?php echo e(__('and')); ?>

    <a href="<?php echo e(route('privacy')); ?>" class="text-info"><?php echo e(__('Privacy Policies')); ?></a>
</span>
                                ...
                                <div class="form-group mb-0">                        
                                   ...
                                   <p class="fs-10 text-muted mt-2">
  or <a class="text-info" href="<?php echo e(route('login')); ?>"><?php echo e(__('Login')); ?></a>
</p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/myperfectwriting.co.uk/portal.myperfectwriting.co.uk/resources/views/auth/register.blade.php ENDPATH**/ ?>