          ...
          <div class=" text-white ">
           ...
           <p>
            ...
            <p>
              My File
				...
				<?php $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <a class="float-right text-light" href="<?php echo e($file->file_path); ?>" download class="text-primary"><i class="fa fa-download"></i> <?php echo e($file->file); ?></a> <br>
			...
			<?php $sw= Illuminate\Support\Facades\DB::table('attachments')->where('order_id', $order->id)->get();  ?>
			  <?php $__currentLoopData = $sw; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $f): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

				

				  <a class="float-right text-white"  href="<?php echo e($f->file_path); ?>" download><?php echo e($f->file); ?> <i class="fa fa-download"></i></a>
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
		       ...
		       <h4 class="page-title mb-0"><?php echo e(__('Check your Order')); ?></h4>
		   			...
		   			<?php if($wf): ?> 
					    ...
					    <div class="form-group">
							...
							<textarea name="message" class="form-control" placeholder="Writer Message"><?php echo e($wf->message); ?></textarea>
           			 	</div>
			     		<div class="form-group">
							<label for="">Writer's File</label>
						<?php $sw= Illuminate\Support\Facades\DB::table('attachments')->where('order_id', $order->id)->get();  ?>
			  			<?php $__currentLoopData = $sw; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>						
							<input type="text" name="file" value="<?php echo e($sf->file); ?>" class="form-control">
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
						</div>
						<div class="form-group my-2" id="downloadFile" style="display:none">
								<label for="">Download File</label>
							<?php $__currentLoopData = $sw; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ssf): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
								<a class="float-right text-white mx-1"  href="<?php echo e($ssf->file_path); ?>" download><i class="fa fa-download"></i></a>
							<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php $__currentLoopData = $conversations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $conv): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
					...
					<p class="font-weight-bold text-primary fs-11"><i class="fa-sharp fa-solid fa-calendar-clock mr-2"></i><?php echo e(date('Y-m-d h:i:A', strtotime($conv->created_at))); ?> <span>MPW</span></p>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/myperfectwriting.co.uk/portal.myperfectwriting.co.uk/resources/views/user/orders/order_details.blade.php ENDPATH**/ ?>