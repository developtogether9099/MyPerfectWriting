					...
					<div class="row text-center justify-content-md-center mt-7">
						...
						<div class="col-lg-3 col-md-3 col-sm-4">
							<div class="referral-icon-user">
								...
								<?php if(config('payment.referral.payment.policy') == 'first'): ?>
									<p class="fs-12"><?php echo e(__('Earn 10% commission on the first order placed by your referral, guaranteed!')); ?>.</p>
								<?php else: ?>
									<p class="fs-12"><?php echo e(__('Earn 10% commission on the first order placed by your referral, guaranteed!')); ?>.</p>
								<?php endif; ?>
							</div>							
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/myperfectwriting.co.uk/portal.myperfectwriting.co.uk/resources/views/user/referrals/index.blade.php ENDPATH**/ ?>