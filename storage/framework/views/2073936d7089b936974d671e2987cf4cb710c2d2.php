...
<?php $__env->startSection('page-header'); ?>
	...
	<div class="page-header mt-5-7">
		...
		<div class="page-rightheader">
			<a href="<?php echo e(route('blogger.blog.create')); ?>" class="btn btn-primary mt-1"><?php echo e(__('Create New Blog')); ?></a>
		</div>
	</div>
	<!-- END PAGE HEADER -->
<?php $__env->stopSection(); ?>
	...
	<script type="text/javascript">
		$(function () {
			...
			var table = $('#blogsTable').DataTable({
				...
				processing: true,
				serverSide: true,
				ajax: "<?php echo e(route('blogger.blogs')); ?>",
				columns: [
					{
						data: 'created-on',
						name: 'created-on',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/myperfectwriting.co.uk/portal.myperfectwriting.co.uk/resources/views/blogger/blogs/index.blade.php ENDPATH**/ ?>