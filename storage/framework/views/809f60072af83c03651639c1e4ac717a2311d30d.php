				...
				<div class="card-body">			
					<div class="text-center">
						...
						<div class="text-center mb-6">
							<p class="mt-5 fs-14"><?php echo e(__('You have successfully Completed Payment process')); ?>.</p>
						</div>						
					
						<div class="text-center pt-2 pb-4">
						
							<a href="<?php echo e(route('user.my_orders')); ?>" id="payment-button" class="btn btn-primary pl-6 pr-6"><?php echo e(__('View Orders')); ?></a>							
						</div>
					</div>
				</div>
			</div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/myperfectwriting.co.uk/portal.myperfectwriting.co.uk/resources/views/user/checkout/success.blade.php ENDPATH**/ ?>