...
<?php $__env->startSection('page-header'); ?>
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0"><?php echo e(__('New Service Post')); ?></h4>
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item" aria-current="page"><a href="<?php echo e(route('admin.settings.service')); ?>"> <?php echo e(__('Services Manager')); ?></a></li>
				<li class="breadcrumb-item active" aria-current="page"><a href="<?php echo e(url('#')); ?>"> <?php echo e(__('New Service Post')); ?></a></li>
			</ol>
		</div>
	</div>
	<!-- END PAGE HEADER -->
		...
		<div class="col-lg-8 col-md-8 col-xm-12">
			<div class="card overflow-hidden border-0">
				<div class="card-header">
					<h3 class="card-title"><?php echo e(__('Create New Service Post')); ?></h3>
				</div>
				<div class="card-body pt-5">									
					<form id="" action="<?php echo e(route('admin.settings.service.store')); ?>" method="post" enctype="multipart/form-data">
						<?php echo csrf_field(); ?>

						<div class="row mt-2">							
							<div class="col-lg-12 col-md-12 col-sm-12">							
								<div class="input-box">								
									<h6><?php echo e(__('Service Title')); ?>  <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
...
unset($__errorArgs, $__bag); ?>	
							...
							<div class="col-lg-6 col-md-6 col-sm-12">							
								<div class="input-box">	
									<h6><?php echo e(__('Service Status')); ?>  <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
			  						<select id="smtp-encryption" name="status" data-placeholder="<?php echo e(__('Service Status')); ?>:">			
							...
							<div class="col-lg-6 col-md-6 col-sm-12">
								<div class="input-box">
									<h6><?php echo e(__('Service Image')); ?></h6>
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="row mt-2">
							<div class="col-lg-12 col-md-12 col-sm-12">	
								<div class="input-box">	
									<h6><?php echo e(__('Service Post Content')); ?> <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>							
...
unset($__errorArgs, $__bag); ?>	
						...
						<div class="border-0 text-right mb-2 mt-1">
							<a href="<?php echo e(route('admin.settings.service')); ?>" class="btn btn-cancel mr-2"><?php echo e(__('Cancel')); ?></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/myperfectwriting.co.uk/httpdocs/resources/views/admin/frontend/Service/create.blade.php ENDPATH**/ ?>