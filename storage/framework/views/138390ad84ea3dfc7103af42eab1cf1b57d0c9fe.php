							...
							<table class="table" id="database-backup">
								...
								<tbody>
									<?php $__currentLoopData = $transaction; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										...
										<td><span class="font-weight-bold"><?php echo e(date('Y-m-d h:i:A',strtotime($data->created_at))); ?></span><br><span><?php echo e(date('Y-m-d h:i:A',strtotime($data->created_at))); ?></span></td>
										</tr>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</tbody>
							</table>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/myperfectwriting.co.uk/portal.myperfectwriting.co.uk/resources/views/admin/dashboard/index.blade.php ENDPATH**/ ?>