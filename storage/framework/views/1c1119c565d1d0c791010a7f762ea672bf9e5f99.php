					...
					<form action="<?php echo e(route('admin.settings.frontend.store')); ?>" method="POST" enctype="multipart/form-data">
						...
						<div class="row">
							...
							<div class="col-md-4 col-sm-12">									
								...
								<div class="col-md-4 col-sm-12">									
								<h6 class="fs-12 font-weight-bold mb-4"><?php echo e(__('Services Section')); ?></h6>								
								<div class="form-group mb-4">
									<label class="custom-switch">
										<input type="checkbox" name="services" class="custom-switch-input" <?php if( config('frontend.services_section')  == 'on'): ?> checked <?php endif; ?>>
										<span class="custom-switch-indicator"></span>
										<span class="custom-switch-description"><?php echo e(__('Show')); ?></span>
									</label>
								</div> 
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/myperfectwriting.co.uk/portal.myperfectwriting.co.uk/resources/views/admin/frontend/frontend/index.blade.php ENDPATH**/ ?>