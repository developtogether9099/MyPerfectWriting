	...
	<script type="text/javascript">
		$(function () {
			...
			var table = $('#listUsersTable').DataTable({
				...
				processing: true,
				serverSide: true,
				ajax: "<?php echo e(route('admin.assign')); ?>",
				columns: [
					{
						data: 'title',
						name: 'title',
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/myperfectwriting.co.uk/portal.myperfectwriting.co.uk/resources/views/admin/orders/assign.blade.php ENDPATH**/ ?>