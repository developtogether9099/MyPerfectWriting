...
<?php $__env->startSection('page-header'); ?>
	...
	<div class="page-header mt-5-7">
		<div class="page-leftheader">
			<h4 class="page-title mb-0"><?php echo e(__('User Support Request')); ?></h4>
			<ol class="breadcrumb mb-2">
				...
				<li class="breadcrumb-item" aria-current="page"><a href="<?php echo e(route('admin.support')); ?>"> <?php echo e(__('Support Requests')); ?></a></li>
		...
		<div class="col-lg-9 col-md-9 col-xm-12">
			<div class="card overflow-hidden border-0">
				...
				<div class="card-body pt-5">	
					...
					<form id="" action="<?php echo e(route('admin.support.response', ['ticket_id' => $ticket->ticket_id])); ?>" method="post" enctype="multipart/form-data">
						<?php echo csrf_field(); ?>

						<div class="row pt-5">
							<div class="col-lg-12 col-md-12 col-sm-12">				
								<div class="input-box">	
									<h6 class="font-weight-bold"><?php echo e(__('Ticket Status')); ?>: <span class="text-required"><i class="fa-solid fa-asterisk"></i></span></h6>
									<select id="response-status" name="response-status" data-placeholder="<?php echo e(__('Select Ticket Status')); ?>:">			
										<option value="Pending" selected><?php echo e(__('Pending')); ?></option>
										<option value="Replied"><?php echo e(__('Replied')); ?></option>
...
unset($__errorArgs, $__bag); ?>
							...
							<div class="col-12 text-center">
								...
								<div class="border-0 mb-2">
									<a href="<?php echo e(route('admin.support')); ?>" class="btn btn-cancel mr-2"><?php echo e(__('Return')); ?></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/myperfectwriting.co.uk/portal.myperfectwriting.co.uk/resources/views/admin/support/show.blade.php ENDPATH**/ ?>