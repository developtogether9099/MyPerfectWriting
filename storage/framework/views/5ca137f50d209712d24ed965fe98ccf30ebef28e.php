      ...
      <div class="card-body pt-2">
        ...
        <div class="box-content" style="color: #ffffff !important;">
          <div class="col-md-12 col-sm-12 pr-4">
            ...
            <div>
              <p class="fs-12 p-family"><?php echo e(__('Subtotal')); ?> <span class="checkout-cost"> <i class="fa <?php echo e(format_amount(1)['icon']); ?>"></i><span id="sub_total">0</span></span></p>
...
<div id="checkouts" style="display:none">
            ...
            <div>
              <p class="fs-12 p-family"><?php echo e(__('Total Payment')); ?> <span class="checkout-cost"> <i class="fa <?php echo e(format_amount(1)['icon']); ?>"></i> <span class="text-info" id="gtotal" style="color: #ffffff !important;">0</span></span></p>
            </div>
              ...
              <div class="card border-0" style="background-color: #3C3465; color: #ffffff;">
                <div class="card-body">
                  ...
                  <div class="card-text">
                    ...
                    <p class="fs-12 p-family">Subtotal: <span class="checkout-cost"><i class="fa <?php echo e(format_amount(1)['icon']); ?>"></i><span id="sub_total2">0</span></span></p>
                    ...
                    <p class="fs-12 p-family" style="color: #ffffff;">Total Payment: <span class="checkout-cost"><i class="fa <?php echo e(format_amount(1)['icon']); ?>"></i><span class="text-info" id="gtotal2">0</span></span></p>
                  </div>
                  <br>
  ...
  <script>
    ...
    $(document).ready(function() {
      ...
      $('#submit-order').submit(function(e) {
        ...
        var url = "<?php echo e(route('user.place_order')); ?>"; // Replace with the actual URL for submitting the order
        if (bool == true) {
          bool = false;
...
<script>
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/myperfectwriting.co.uk/portal.myperfectwriting.co.uk/resources/views/user/orders/services.blade.php ENDPATH**/ ?>