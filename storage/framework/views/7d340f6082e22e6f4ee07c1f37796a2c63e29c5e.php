		...
		<div class="col-lg-8 col-md-8 col-xm-12">
			<div class="card overflow-hidden border-0">
				...
				<div class="card-body pt-5">									
					<form id="" action="<?php echo e(route('blogger.blog.store')); ?>" method="post" enctype="multipart/form-data">
						<?php echo csrf_field(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/myperfectwriting.co.uk/httpdocs/resources/views/blogger/blogs/create.blade.php ENDPATH**/ ?>