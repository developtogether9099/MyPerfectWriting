...
<div id="checkouts" style="display:none">
            ...
            <div>
              <p class="fs-12 p-family"><?php echo e(__('Total Payment')); ?> <span class="checkout-cost"> <i class="fa <?php echo e(format_amount(1)['icon']); ?>"></i> <span class="text-info" id="gtotal">0</span></span></p>
            </div>
...
<script>
  ...
  <?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/myperfectwriting.co.uk/httpdocs/resources/views/user/orders/services.blade.php ENDPATH**/ ?>