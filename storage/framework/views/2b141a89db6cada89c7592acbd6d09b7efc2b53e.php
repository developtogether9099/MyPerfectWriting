							...
							<div class="text-center p-4">
								<div class="d-flex w-100">
									<div class="flex w-100">
										<div class="flex w-100">
											<h4 class="mb-3 mt-1 font-weight-800 text-primary text-shadow fs-16"><?php echo e(App\Services\HelperService::userAvailableWords()); ?> / <?php echo e(App\Services\HelperService::userPlanTotalWords()); ?></h4>
											<h6 class="text-white fs-12 text-shadow"><?php echo e(__('Words Left')); ?></h6>
										</div>
										<div class="flex w-100 mt-4">
											<h4 class="mb-3 mt-1 font-weight-800 text-primary text-shadow fs-16"><?php echo e(App\Services\HelperService::userAvailableImages()); ?> / <?php echo e(App\Services\HelperService::userPlanTotalImages()); ?></h4>
											<h6 class="text-white fs-12 text-shadow"><?php echo e(__('Images Left')); ?></h6>
										</div>
									</div>
									<div class="flex w-100">
										<div class="flex w-100">
											<h4 class="mb-3 mt-1 font-weight-800 text-primary text-shadow fs-16"><?php echo e(App\Services\HelperService::userAvailableChars()); ?> / <?php echo e(App\Services\HelperService::userPlanTotalChars()); ?></h4>
											<h6 class="text-white fs-12 text-shadow"><?php echo e(__('Characters Left')); ?></h6>
										</div>
										<div class="flex w-100 mt-4">
											<h4 class="mb-3 mt-1 font-weight-800 text-primary text-shadow fs-16"><?php echo e(App\Services\HelperService::userAvailableMinutes()); ?> / <?php echo e(App\Services\HelperService::userPlanTotalMinutes()); ?></h4>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/myperfectwriting.co.uk/portal.myperfectwriting.co.uk/resources/views/user/profile/index.blade.php ENDPATH**/ ?>