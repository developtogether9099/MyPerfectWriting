	...
	<div class="col-xl-9 col-lg-8 col-sm-12">
		<div class="card border-0">
			...
			<div class="card-body pb-0">
				<form method="POST" action="<?php echo e(route('admin.writer_update', $writer->id)); ?>" enctype="multipart/form-data">
					<?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" name="username" id="username" value="<?php echo e($writer->username); ?>" readOnly required>
									</div>
						...
						<div class="col-sm-6 col-md-6">
							<div class="input-box">
								<div class="form-group">
									...
									<input type="text" value="<?php echo e($writer->name); ?>" class="form-control <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-danger <?php unset($message);
						...
						<div class="col-sm-6 col-md-6">
							<div class="input-box">
								<div class="form-group">
									...
									<input type="email" value="<?php echo e($writer->email); ?>" class="form-control <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-danger <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
						...
						<div class="col-sm-6 col-md-6">
							<div class="input-box">
								<div class="form-group">
									<label class="form-label fs-12"><?php echo e(__('Write New Password')); ?> </label>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/myperfectwriting.co.uk/portal.myperfectwriting.co.uk/resources/views/admin/writers/edit.blade.php ENDPATH**/ ?>