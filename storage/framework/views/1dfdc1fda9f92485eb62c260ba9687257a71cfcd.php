...
<html lang="<?php echo e(str_replace('_', '-', app()->getLocale())); ?>">
					...
					<div class="page-main">
						...
						<section id="main-wrapper">
							...
							<div class="relative flex items-top justify-center min-h-screen">
								...
								<div class="container-fluid fixed-top" id="navbar-container" style="background: #ffffff;">
  ...
  <img src="<?php echo e(URL::asset('img/brand/logo.png')); ?>" alt="My Perfect Writing" style="width: 200px;">
</a>
												...
												<div class="collapse navbar-collapse section-links" id="navbarNav">
													<ul class="navbar-nav">
														<li class="nav-item">
															<a class="nav-link scroll" id="home" href="<?php echo e(route('home')); ?>"><?php echo e(__('Home')); ?> <span class="sr-only">(current)</span></a>
														</li>		
														<?php if(config('frontend.pricing_section') == 'on'): ?>
															<li class="nav-item">
																<a class="nav-link scroll" href="<?php echo e(route('pricing')); ?>"><?php echo e(__('Pricing')); ?></a>
															</li>
														<?php endif; ?>							
													
															<?php if(config('frontend.blogs_section') == 'on'): ?>
															<li class="nav-item">
																<a class="nav-link scroll" id="blogss" href="<?php echo e(route('blogs')); ?>"><?php echo e(__('Blogs')); ?></a>
															</li>
														<?php endif; ?>
														
														<?php if(config('frontend.services_section') == 'on'): ?>
															<li class="nav-item">
																<a class="nav-link scroll" id="services" href="<?php echo e(route('services')); ?>"><?php echo e(__('Services')); ?></a>
															</li>
														<?php endif; ?>
														<?php if(config('frontend.faq_section') == 'on'): ?>
															<li class="nav-item">
																<a class="nav-link scroll" href="<?php echo e(route('home')); ?>/#faq-wrapper"><?php echo e(__('FAQs')); ?></a>
															</li>
														<?php endif; ?>
														<?php if(config('frontend.contact_section') == 'on'): ?>
															<li class="nav-item">
																<a class="nav-link scroll" href="<?php echo e(route('home')); ?>/#contact-wrapper"><?php echo e(__('Contact Us')); ?></a>
															</li>
														<?php endif; ?>
					...
					<div id="footer" class="container text-center">
						...
						<div class="row">    
							...
							<div class="col-md-4 col-sm-12" id="footer-logo">
								...
								<p class="mb-0">We specializes in creating written content for various purposes.We have a team of writers who are skilled in creating different types of content, including eassy writing, articles, blog posts, product descriptions, social media posts, and more.</p>		
								...
								<div class="row w-100">
									...
									<div class="col-md-3 col-sm-12">
										...
										<ul class="list-unstyled">
											<li><a href="#" target="_blank"><?php echo e(__('About Us')); ?></a></li>                             
										</ul>
    ...
    // Split the URL by slashes and get the last segment (content after the last slash)
    const urlSegments = currentURL.split('/');
    const contentAfterSlash = urlSegments[urlSegments.length - 1];

    // Update the HTML element's content
						if(contentAfterSlash == 'blogs'){
							var element = document.getElementById('blogss');
							element.classList.add('active');
						} else if(contentAfterSlash == 'services'){
...
<?php endif; ?><?php /**PATH /var/www/vhosts/myperfectwriting.co.uk/portal.myperfectwriting.co.uk/resources/views/layouts/frontend.blade.php ENDPATH**/ ?>