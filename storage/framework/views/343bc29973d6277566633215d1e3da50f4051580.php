...
unset($__errorArgs, $__bag); ?>
							...
							<div class="col-lg-6 col-md-6col-sm-12">							
								<div class="input-box">								
									...
									<select id="promo-usage" name="usage" data-placeholder="<?php echo e(__('Select Promocode Usage')); ?>:" data-callback="singleUsageCheck">			
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/vhosts/myperfectwriting.co.uk/portal.myperfectwriting.co.uk/resources/views/admin/finance/promocodes/create.blade.php ENDPATH**/ ?>